...
from app.config.config import APP_DIR
from app.extensions import bcrypt, db, load_user, login_manager
from app.factory import create_app
from app.models import Activity, Admin, AuditLog, Comparable, Prediction, User
